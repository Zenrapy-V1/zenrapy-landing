...
const JoinUs = () => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://gist.githubusercontent.com/mofesolapaul/d63b14a0465b5841d9bb0f6d2f8b627f/raw/60f278334da48457b8e155b8af27e85067bf23e0/nigeria-states-and-local-govts.json"
      )
      .then((response) => {
  ...
  return (
    <>
      ...
      <p>Already registered and got aproved? <Link>Sign-In</Link></p>
